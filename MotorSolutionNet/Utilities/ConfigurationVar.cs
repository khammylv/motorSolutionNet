...
namespace MotorSolutionNet.Utilities
{
    ...
    public class ConfigurationVarUser
    {
        ...
        public static string UserEnumRole = "EXEC usp_getRole";
        public static string GetUsersByCompany = "usp_GetUsersWithCompanyByCompanyCode";
    }
    public class ConfigurationVarCompany
    {
    ...
    public class ConfigurationVarVehicle
    {
    ...
    public class ConfigurationVarRepair
    {
        ...
        public static string UpdateStatus = "usp_updateRepairStatus";
        public static string GetEnumStatus = "EXEC usp_getRepairStatus";
        public static string GetrepairDTO = "usp_getRepairDto";
        public static string DoneRepair = "usp_DoneRepair";
        public static string GetStatusSumary = "usp_GetRepairStatusSummary";
    }

    public class ConfigurationVarDetailRepair
    {
        public static string AddRepairDetails = "usp_AddDetailRepair";
        public static string GetByRepairID = "usp_GetRepairDetailsByRepairId";
        public static string GetByID = "usp_GetRepairDetailsByRepairDetailsId";
        public static string UpdateRepairDetails = "usp_updateDetailRepair";
        public static string DeleteRepairDetails = "usp_DeleteDetailsRepair";
    }
    public class ConfigurationVarBilling
    {
        ...
        public static string GetBillingByRepairId = "usp_GetBillingByRepairId";
    }
}